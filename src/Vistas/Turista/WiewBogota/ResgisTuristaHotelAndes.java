 ...
 * @author SARA
 */
public class ResgisTuristaHotelAndes extends javax.swing.JFrame {

    /**
     * Creates new form resgistarturistacartagena
     */
    public ResgisTuristaHotelAndes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(80, 10, 410, 26);
...
JOptionPane.showMessageDialog(this, "Reserva guardada exitosamente.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResgisTuristaHotelAndes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

 ...
 */
public class RegisTuristaCartagenaPlaza extends javax.swing.JFrame {

    /**
     * Creates new form RegisTuristaCartagenaPlaza
     */
    public RegisTuristaCartagenaPlaza() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(0, 310, 90, 24);
...
JOptionPane.showMessageDialog(this, "Reserva guardada exitosamente.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisTuristaCartagenaPlaza.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
